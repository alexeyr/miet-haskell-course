...
-- В школе ан первых уроках по физике я написал простейший пошаговый симулятор
-- посадки космического корабля на Луну. Пользователь каждый шаг вводит ускорение,
-- которое должно двигатель долэен придать кораблю. Если в корабле кончается топливо
-- и он слишком на большой скорости врезается в поверзность – проиграл, мягкая посадка –
-- победа!
--
-- Настройки
gravity :: Double
