...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Не нужно для каждой функции документировать, как работает с \haskinline|null|, достаточно посмотреть на наличие \haskinline|Maybe| в сигнатуре.
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Соответственно, функции над ними тоже определяются рекурсивно:
          \begin{haskell}
            replicate 0 _ = [] -- упрощённое определение из Prelude
