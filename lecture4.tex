...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item Почти все определения \haskinline|(==)| устроены одинаково:\pause
          ...
          \end{itemize}
    \item Почти, но не все: \pause например, для \haskinline|Data.Set| и \haskinline|Data.Map| (два сбалансированных дерева с одними и теми же элементами могут иметь разную форму) или для типов с кэшированными полями.\pause
