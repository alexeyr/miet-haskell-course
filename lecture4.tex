  ...
  \begin{itemize}
    ...
    \item Но у \haskinline|Double| есть \haskinline|NaN|, который не сравним ни с чем, а \haskinline|Ordering| не может этого выразить:
          \begin{haskell}
            ...
            False
          \end{haskell}
    \item Если бы \haskinline|(<)| определялось через \haskinline|compare|, получилось бы \haskinline|True|.
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item Для \haskinline|newtype| можно вывести любой класс.\pause
