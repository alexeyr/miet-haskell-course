...
\begin{frame}[fragile]
  \frametitle{Будущее (и недавнее прошлое) Haskell}
  \begin{itemize}
    \item \href{https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/exts/linear_types.html}{Линейные типы} (GHC 9.0+): значения, которые можно использовать только один раз.
          \begin{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item ФП без сборщика мусора: Rust.
          ...
          \end{itemize}
          \pause
    \item Языки с зависимыми типами: Agda, Idris, Rocq.
          \pause
  ...
  \begin{itemize}
    ...
    \item Математическая логика в целом
          \begin{itemize}
            ...
            \item Agda, Idris, Rocq (бывший Coq) и Lean сюда же!
          \end{itemize}
          \pause
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item \href{https://doc.rust-lang.org/book/}{The Rust Programming Language} (книга, доступна бесплатно)
